...
# Ver 1.2 feature upgrade - added purse of 1000 gold and calculating how much is spent.
purse = 1000
# create stores
...
for shop in (freelancers, antiques, pet_shop):
    ...
    # Ver 1.2 feature update - add ability to exit store without purchase.
    if buy_item == "exit":
        continue
...
# Ver 1.2 feature update - calculate how much gold is left over
