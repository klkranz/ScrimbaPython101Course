# project Euler #4 - find the largest palindrome of two 3 - digit numbers 
# a palindrome is a number that is the same backwards and forwards, like 101 or 990099
# NOTE - technically, his code is not including all the numbers in the range because the end range is not inclusive.
import time
