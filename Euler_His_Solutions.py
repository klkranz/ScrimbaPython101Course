# project Euler #4 - the largest palindrome of two 3-digit numbers
            ...
            for dig3 in range(10):
                ...
                for digit in range(low_val, high_val):
                    ...
                    if palindrome % digit == 0:
                        # check for divisibility, since we are stepping through palindromes in order,
                        # as soon as we find one: we are Done!
    ...
    for dig1 in range(9, 0, -1):
        for dig2 in range(9, -1, -1):
            for dig3 in range(9, -1, -1):
                # we create the -palindromes by adding the 'place values',
                ...
                #print(palindrome, type(palindrome))  # debug
